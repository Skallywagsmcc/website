...
@section("content")
    <div class="container">
        ...
        <form action="{{$url->make("admin.users.update")}}" method="post" class="tld-form">
            {{csrf()}}
            ...
            <div class="form-group text-right">
                ...
                <input type="checkbox" name="is_admin" @if($user->is_admin = 1) checked @endif value="{{$user->is_admin}}">
                <hr>
