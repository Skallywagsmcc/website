...
@section("content")
    ...
    <div class="row">
        <div class="col-md-3">
{{--            Navbar goes here--}}
            <a href="{{$url->make("admin.pages.new")}}">New Page</a>
        </div>
        <div class="col-md-9">
            ...
            @foreach($articles as $article)
                <div class="row text-center  m-2 mx-md-0 p-2 article-row">
                    ...
                    <div class="col-md-2"><a href="{{$url->make("admin.pages.edit",["slug"=>$art->slug,"id"=>base64_encode($article->id)])}}">Edit Article</a></div>
