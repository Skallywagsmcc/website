...
@section("content")
    <div class="container my-2">
            ...
            <div class="row">
                @foreach($charters as $charter)
                    <div class="col-sm-12 col-lg-4">
                        <div class="col-sm 12 head">{{$charter->title}}</div>
                        <div class="col-sm-12">
                            <img class=" my-2" src="/img/uploads/{{$charter->image->name}}" alt="{{$charter->title}}" height="150" width="100%">
                        </div>
                        <div class="col-sm-12 text-center text-lg-right pr-lg-2">
                            <a href="{{$url->make("charters.view",["slug"=>$charter->slug])}}">View Charter</a>
                        </div>
                    </div>
                @endforeach
            </div>
        @else
            <div class="row">
                <div class="col-sm-12 head lb3">No Charters have been found</div>
            </div>
        @endif
    </div>
...
{{--                                <img src="/img/uploads/{{$charter->image->name}}" alt="" class="profile_pic m-1"--}}
{{--                                     height="200px" width="200px">--}}
{{--                            </div>--}}
{{--                            <div class="text-center my-2 lb2 base_border"><a--}}
{{--                                        href="{{$url->make("charters.view",["slug"=>$charter->slug])}}"--}}
{{--                                        class="d-block py-2">{{$charter->title}}</a></div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                @endforeach--}}
