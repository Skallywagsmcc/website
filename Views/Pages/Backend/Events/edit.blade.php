    ...
    <div class="container">
        <form action="{{$url->make("admin.events.update")}}" method="post" class="tld-form">
            ...
            <div class="bg-dark my-2">
                ...
                <div class="toggled_content">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control tld-input" name="start" value="{{$event->start}}">
                    </div>
                </div>
            </div>
            <div class=bg-dark my-2>
                ...
                <div class="toggled_content">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control tld-input" name="end" value="{{$event->end}}">
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control tld-input" tld-input" value="{{$address[0]}}">
            </div>

            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="street">Street name</label>
                    <input type="text" name="street" class="form-control tld-input" tld-input" value="{{$address[1]}}">
                </div>
                <div class="form-group col-md-6">
                    <label for="city">City</label>
                    <input type="text" name="city" class="form-control tld-input" tld-input" value="{{$address[2]}}">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="postcode" class="form-control tld-input"" value="{{$address[4]}}">
                </div>
            </div>
