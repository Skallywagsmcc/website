...
@section("content")
    ...
    <div class="container-fluid my-2">
        <div class="row box">
            <div class="col-sm-12 head py-2">Create a new Address</div>
        </div>

        <form action="{{$url->make("auth.admin.contact.address.update",["id"=>base64_encode($request->id)])}}" method="post">
            {{csrf()}}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <button class="btn btn-block btn-primary">Update Address</button>
                </div>
            </div>
        </form>
    </div>
