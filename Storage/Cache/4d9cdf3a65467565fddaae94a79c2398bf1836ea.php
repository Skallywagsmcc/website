...
<div  class="container-fluid text-center text-md-left my-3 py-2" id="account_bar">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            <?php if(\App\Http\Models\Profile::where("user_id",\App\Http\Libraries\Authentication\Auth::id())->get()->first()->profile_pic == null): ?>
                <img src="/img/logo.png" alt="Logo" class="profile_pic">
                <?php echo e(\App\Http\Libraries\Authentication\Auth::getusername()); ?>

            <?php else: ?>
                <img src="/img/uploads/<?php echo e(\App\Http\Models\User::find(\App\Http\Libraries\Authentication\Auth::id())->Profile->Image->name); ?>" alt="<?php echo e($image->name); ?>" class="profile_pic">
                <?php echo e(\App\Http\Libraries\Authentication\Auth::getusername()); ?>
