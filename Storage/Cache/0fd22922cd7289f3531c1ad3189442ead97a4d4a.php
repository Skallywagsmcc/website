    ...
    <div class="col-sm-12">
        <form action="<?php echo e($url->make("login.store")); ?>" method="post" class="tld-form">
            <div class="form-group tld-form">
                ...
                <input type="text" name="username" class=" form-control tld-input" value="<?php echo e($username); ?>" placeholder="Email Address or username">
            </div>
...
<?php /**PATH /var/www/html/public_html/Views/Includes/Frontend/login.blade.php ENDPATH**/ ?>